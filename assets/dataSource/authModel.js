class AUTHENTICATION {
    LOGIN = async (user_id, user_pw) => {
        try {
            let response = await fetch('http://localhost:8888/api/auth/login', {
                method: 'POST',
                headers: {
    ...
    LOGOUT = async () => {
        try {
            let response = await fetch('http://localhost:8888/api/auth/logout', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    REGISTER = async (data) => {
        try {
            let response = await fetch('http://localhost:8888/api/auth/register', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
