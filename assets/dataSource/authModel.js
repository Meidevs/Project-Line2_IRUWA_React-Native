class AUTHENTICATION {
    LOGIN = async (user_id, user_pw) => {
        try {
            let response = await fetch('http://127.0.0.1:8888/api/auth/login', {
                method: 'POST',
                headers: {
    ...
    LOGOUT = async () => {
        try {
            let response = await fetch('http://127.0.0.1:8888/api/auth/logout', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    REGISTER = async (data) => {
        try {
            let response = await fetch('http://127.0.0.1:8888/api/auth/register', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    GET_USER_LOCATION = async () => {
        try {
            let response = await fetch('http://127.0.0.1:8888/api/auth/info', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    UPDATE_USER_LOCATION = async (user_location) => {
        try {
            let response = await fetch('http://127.0.0.1:8888/api/auth/userlocation', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
